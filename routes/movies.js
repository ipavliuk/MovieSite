...
db = new Db('moviedb', server, {safe: true});
    ...
    var movies = [
        {
            name: "Форрест Гамп",
            year: "1994",
            directedBy: "Роберт Земекіс",
            country: "США",
            genre : "Драма",
            description: "Зворушлива історія про звичайного американського хлопця, який з дитинства страждав через свою простодушність. Тим не менш, саме доброта і стала тим стержнем, який тримав його усе життя і дозволяв переживати навіть найбільші трагедії.",
            picture: "forest_gump.jpg"
        },
        {
            name: "Амелі",
            year: "2001",
            directedBy: "Жан-Пьєн Жене",
            country: "",
            genre: "Драма",
            description: "Ванільна на перший погляд і тим не менш глибока за змістом історія дівчини з Парижу, яка вирішила принести трохи добра у цей світ і заодно сама отримала бажане щастя. По-французьки дивно, але так само романтично і цікаво.",
            picture: "amelie.jpg"
        },
        {
            name: "Матриця / The Matrix",
            year: "1999",
            directedBy: "Брати Вачовскі",
            country: "США",
            genre: "Драма",
            description: "Перша частина культової трилогії про Матрицю, спеціальний вимір людського життя, який створено машинами для симуляції справжнього світу. Фільм спричинив справжній сплеск популярності, яка вилилась у комікси, комп’ютерні ігри, інші види мистецтва та філософські дискусії з приводу людського буття.",
            picture: "matrix.jpg"
        },
        {
            name: "Сім життів / Seven Pounds",
            year: "2007",
            directedBy: "Габріель Муччіно",
            country: "США",
            genre: "Драма",
            description: "Вражаюча драма італійського режисера Габріеля Муччіно, яка розповідає про Бена Томаса, з вини якого загинули семеро людей. Після цього він покидає свою кар’єру і починає крок за кроком жертвувати собою заради інших людей – у буквальному сенсі.",
            picture: "seven_pounds.jpg"
        },
        {
            name: "Ігри розуму / Beautiful mind",
            year: "2001",
            directedBy: "Рон Ховард",
            country: "США",
            genre: "Драма",
            description: "Біографічна драма, в якій йдеться про життя Джона Форбса Неша, нобелівського лауреата з економіки – шлях до успіху супроводжувався численними розладами психіки. Фільм здобув 4 премії Оскар та зібрав більше $300 млн в усьому світі.",
            picture: "buitifulmind.jpg"
        },
        {
            name: "Достукатись до небес",
            year: "1997",
            directedBy: "Томас Ян",
            country: "Німеччина",
            genre: "Драма",
            description: "Фільм німецького сценариста і режисера Томаса Яна, назва якого походить від знаменитої пісні Боба Ділана. Дія фільму починається в лікарні, де двоє молодих людей в одній палаті дізнаються один від одного, що їм залишилось жити лічені дні.",
            picture: "knocking.jpg"
        },
        {
            name: "Втеча з Шоушенка",
            year: "1994",
            directedBy: "Френк Дарабонт",
            country: "США",
            genre: "Драма",
            description: "Ще один топовий фільм Френка Дарабонта, що також було знято на основі твору Стівена Кінга. Уже тривалий час ця стрічка займає перше місце у списку IMDb-250. Головний герой фільму, Енді Дюфрейн, зазнає ув’язнення за вбивство своєї дружини, якого він не здійснював, і зважується на втечу.",
            picture: "showshenk.jpg"
        },
        {
            name: "Зелена миля",
            year: "1999",
            ...
            country: "",
            genre: "Драма",
            description: "Містична драма за романом Стівена Кінга, що здобула десятки номінацій на різноманітні кінонагороди та міцно посіла своє місце в топ-фільмів IMDb. Сюжет фільму обертається навколо наглядача у федеральній тюрмі, який працює в блоці з засудженими на смерть.",
            picture: "greenmile.jpg"
        },
        {
            name: "Заплати наперед / Pay It Forward",
            year: "2000",
            directedBy: "Мімі Ледер",
            country: "США",
            genre: "Драма",
            description: "В центрі сюжету – учень сьомого класу, мати якого розривається між двома роботами та зловживає алкоголем у вільний час. Завдяки новому вчителю хлопець вирішує зробити три добрі справи у намаганні змінити світ на краще.",
            picture: "payitforward.jpg"
        }];
